...
-(void)closeOtherCombox
{
    ...
    {
        if([subView isKindOfClass:[HLComBoxView class]]&&subView!=self)
        {
            HLComBoxView *otherCombox = (HLComBoxView *)subView;
...
+ (void)closeAllCombox:(UIView *)superView
{
    ...
    {
        if([subView isKindOfClass:[HLComBoxView class]])
        {
            HLComBoxView *combox = (HLComBoxView *)subView;
            if(combox.isOpen)
            {
                [UIView animateWithDuration:0.3 animations:^{
